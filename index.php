...
<main class="form-signin">
  <form action="acoes/login.php" method="POST">
    ...
    <img src="images/icon.ico" alt="Logo" class="img-fluid" max-width="50px" />

    <h1 class="h3 mb-3 fw-normal">Allana TodaBella Multimarcas</h1>
    ...
    <p class="mt-5 mb-3 text-muted"> Almir Lima &copy; 2021</p>
  </form>
</main>
